<template>
    <div class="fill-height layout wrap justify-center align-center">
        ...
        <div class="fill-height layout justify-center align-center">
            <div>
                <h1 class="display-3 text-xs-center">Enjoy these benefits:</h1>
                <ul class="title font-weight-regular mt-4">
                    <li>Plan Sync</li>
                    <li>Export Schedule to Calendar</li>
                    <li>Course Recommendations</li>
                    <li>Notifications of Empty Seats</li>
                    <li>See your Degree Progress</li>
                </ul>
            </div>
        </div>
    </div>
